# License : GPLv2.0
# copyright (c) 2023 Wolfdud3
# based on code by Dave Bailey (dbisu, @daveisu); modified to handle more payloads
...
# uncomment these lines for non_US keyboards, replace LANG with other keyboard layout
...
payload5Pin = digitalio.DigitalInOut(GP14)
payload5Pin.switch_to_input(pull=digitalio.Pull.UP)
payload6Pin = digitalio.DigitalInOut(GP15)
